...
struct kobj_attribute sysfs_attr =
    __ATTR(sysfs_val, 0660, sysfs_show, sysfs_store);
...
static int __init chr_driver_init(void) {
  ...
  /* Setup the timer tocall timer callback fucntion */
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("A. H.");
MODULE_DESCRIPTION("The Sysfs device driver");
